...
class UnweightedUniqueElementsGraphInitTests: XCTestCase {
    ...
    func testCycleInitializerUndirected() {
        ...
        XCTAssertEqual(g2Cycle.edgeCount, 1, "g2Cycle: Expected exactly 1 edges")
        ...
        XCTAssertEqual(g5Cycle.edgeCount, 6, "g5Path: Expected exactly 7 edges")
        ...
        XCTAssertTrue(g5Cycle.vertex("Atlanta", isAdjacentTo: "Atlanta"), "g5Cycle: Expected an edge from Atlanta to Atlanta")
